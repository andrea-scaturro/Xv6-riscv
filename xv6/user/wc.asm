...
wc(int fd, char *name)
{
  ...
  3c:	8f8a0a13          	add	s4,s4,-1800 # 930 <malloc+0xf0>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  aa:	8a250513          	add	a0,a0,-1886 # 948 <malloc+0x108>
  ...
  d8:	86450513          	add	a0,a0,-1948 # 938 <malloc+0xf8>
...
main(int argc, char *argv[])
{
 ...
 120:	344080e7          	jalr	836(ra) # 460 <open>
 124:	84aa                	mv	s1,a0
 ...
 154:	80858593          	add	a1,a1,-2040 # 958 <malloc+0x118>
 158:	4501                	li	a0,0
 ...
 174:	7f050513          	add	a0,a0,2032 # 960 <malloc+0x120>
...
stat(const char *n, struct stat *st)
{
 ...
 2e4:	180080e7          	jalr	384(ra) # 460 <open>
  if(fd < 0)
 ...
 2f4:	188080e7          	jalr	392(ra) # 478 <fstat>
 2f8:	892a                	mv	s2,a0
  close(fd);
 2fa:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 508:	4d450513          	add	a0,a0,1236 # 9d8 <digits>
 50c:	883a                	mv	a6,a4
 50e:	2705                	addw	a4,a4,1
 510:	02c5f7bb          	remuw	a5,a1,a2
 514:	1782                	sll	a5,a5,0x20
 516:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 604:	00271793          	sll	a5,a4,0x2
 608:	00000717          	auipc	a4,0x0
 60c:	37870713          	add	a4,a4,888 # 980 <malloc+0x140>
 ...
 696:	346b8b93          	add	s7,s7,838 # 9d8 <digits>
 ...
 6ea:	29290913          	add	s2,s2,658 # 978 <malloc+0x138>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 84e:	e456                	sd	s5,8(sp)
 850:	e05a                	sd	s6,0(sp)
 852:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 854:	02051493          	sll	s1,a0,0x20
 858:	9081                	srl	s1,s1,0x20
 85a:	04bd                	add	s1,s1,15
 85c:	8091                	srl	s1,s1,0x4
 85e:	0014899b          	addw	s3,s1,1
 862:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 890:	77490913          	add	s2,s2,1908 # 1000 <freep>
  if(p == (char*)-1)
 894:	5afd                	li	s5,-1
 896:	a895                	j	90a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 898:	00001797          	auipc	a5,0x1
 89c:	97878793          	add	a5,a5,-1672 # 1210 <base>
 ...
 91a:	b92080e7          	jalr	-1134(ra) # 4a8 <sbrk>
  if(p == (char*)-1)
