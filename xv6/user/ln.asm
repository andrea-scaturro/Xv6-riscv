...
main(int argc, char *argv[])
{
  ...
  36:	324080e7          	jalr	804(ra) # 356 <link>
...
stat(const char *n, struct stat *st)
{
 ...
 1ba:	180080e7          	jalr	384(ra) # 336 <open>
  if(fd < 0)
 ...
 1ca:	188080e7          	jalr	392(ra) # 34e <fstat>
 1ce:	892a                	mv	s2,a0
  close(fd);
 1d0:	8526                	mv	a0,s1
...
malloc(uint nbytes)
{
 ...
 7f0:	b92080e7          	jalr	-1134(ra) # 37e <sbrk>
  if(p == (char*)-1)
