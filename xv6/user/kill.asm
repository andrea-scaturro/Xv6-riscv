...
main(int argc, char **argv)
{
  ...
  4c:	7b858593          	add	a1,a1,1976 # 800 <malloc+0xe6>
  50:	4509                	li	a0,2
...
stat(const char *n, struct stat *st)
{
 ...
 1be:	180080e7          	jalr	384(ra) # 33a <open>
  if(fd < 0)
 ...
 1ce:	188080e7          	jalr	392(ra) # 352 <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	49a50513          	add	a0,a0,1178 # 878 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e6:	33e70713          	add	a4,a4,830 # 820 <malloc+0x106>
 ...
 570:	30cb8b93          	add	s7,s7,780 # 878 <digits>
 ...
 5c4:	25890913          	add	s2,s2,600 # 818 <malloc+0xfe>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 76a:	89a90913          	add	s2,s2,-1894 # 1000 <freep>
  if(p == (char*)-1)
 76e:	5afd                	li	s5,-1
 770:	a895                	j	7e4 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 772:	00001797          	auipc	a5,0x1
 776:	89e78793          	add	a5,a5,-1890 # 1010 <base>
