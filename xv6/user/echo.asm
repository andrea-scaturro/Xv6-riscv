...
main(int argc, char *argv[])
{
  ...
  34:	800a8a93          	add	s5,s5,-2048 # 830 <malloc+0xec>
  ...
  76:	7c658593          	add	a1,a1,1990 # 838 <malloc+0xf4>
  7a:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 1e8:	180080e7          	jalr	384(ra) # 364 <open>
  if(fd < 0)
 ...
 1f8:	188080e7          	jalr	392(ra) # 37c <fstat>
 1fc:	892a                	mv	s2,a0
  close(fd);
 1fe:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40c:	49850513          	add	a0,a0,1176 # 8a0 <digits>
 410:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 510:	33c70713          	add	a4,a4,828 # 848 <malloc+0x104>
 ...
 59a:	30ab8b93          	add	s7,s7,778 # 8a0 <digits>
 ...
 5ee:	25690913          	add	s2,s2,598 # 840 <malloc+0xfc>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 81e:	b92080e7          	jalr	-1134(ra) # 3ac <sbrk>
  if(p == (char*)-1)
