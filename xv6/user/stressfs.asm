...
main(int argc, char *argv[])
{
  ...
  8e:	358080e7          	jalr	856(ra) # 3e2 <open>
  92:	892a                	mv	s2,a0
  94:	44d1                	li	s1,20
  for(i = 0; i < 20; i++)
//    printf(fd, "%d\n", i);
  ...
  d0:	316080e7          	jalr	790(ra) # 3e2 <open>
  d4:	892a                	mv	s2,a0
  d6:	44d1                	li	s1,20
  for (i = 0; i < 20; i++)
...
stat(const char *n, struct stat *st)
{
 ...
 266:	180080e7          	jalr	384(ra) # 3e2 <open>
  if(fd < 0)
 ...
 276:	188080e7          	jalr	392(ra) # 3fa <fstat>
 27a:	892a                	mv	s2,a0
  close(fd);
 27c:	8526                	mv	a0,s1
