...
main(void)
{
  ...
  1a:	2ac080e7          	jalr	684(ra) # 2c2 <exit>
    printf("zombie process pid: %d\n", pid);
  1e:	85aa                	mv	a1,a0
  20:	00000517          	auipc	a0,0x0
  24:	7c050513          	add	a0,a0,1984 # 7e0 <malloc+0xee>
  28:	00000097          	auipc	ra,0x0
  2c:	612080e7          	jalr	1554(ra) # 63a <printf>
    sleep(5);  // Let child exit before parent.
  30:	4515                	li	a0,5
  32:	00000097          	auipc	ra,0x0
  36:	330080e7          	jalr	816(ra) # 362 <sleep>
  3a:	bfe9                	j	14 <main+0x14>
...
stat(const char *n, struct stat *st)
{
 ...
 196:	180080e7          	jalr	384(ra) # 312 <open>
  if(fd < 0)
 ...
 1a6:	188080e7          	jalr	392(ra) # 32a <fstat>
 1aa:	892a                	mv	s2,a0
  close(fd);
 1ac:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ba:	4a250513          	add	a0,a0,1186 # 858 <digits>
 3be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	34670713          	add	a4,a4,838 # 800 <malloc+0x10e>
 ...
 548:	314b8b93          	add	s7,s7,788 # 858 <digits>
 ...
 59c:	26090913          	add	s2,s2,608 # 7f8 <malloc+0x106>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7cc:	b92080e7          	jalr	-1134(ra) # 35a <sbrk>
  if(p == (char*)-1)
