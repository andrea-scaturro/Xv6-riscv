...
main(int argc, char *argv[])
{
  ...
  2c:	334080e7          	jalr	820(ra) # 35c <unlink>
  ...
  40:	7e458593          	add	a1,a1,2020 # 820 <malloc+0xf4>
  44:	4509                	li	a0,2
  ...
  5e:	7de58593          	add	a1,a1,2014 # 838 <malloc+0x10c>
  62:	4509                	li	a0,2
...
stat(const char *n, struct stat *st)
{
 ...
 1d0:	180080e7          	jalr	384(ra) # 34c <open>
  if(fd < 0)
 ...
 1e0:	188080e7          	jalr	392(ra) # 364 <fstat>
 1e4:	892a                	mv	s2,a0
  close(fd);
 1e6:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	4c850513          	add	a0,a0,1224 # 8b8 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f8:	36c70713          	add	a4,a4,876 # 860 <malloc+0x134>
 ...
 5d6:	28690913          	add	s2,s2,646 # 858 <malloc+0x12c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 788:	88c78793          	add	a5,a5,-1908 # 1010 <base>
 ...
 806:	b92080e7          	jalr	-1134(ra) # 394 <sbrk>
  if(p == (char*)-1)
