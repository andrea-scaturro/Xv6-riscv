...
main(int argc, char **argv)
{
  ...
  procs();
   ...
   c:	2d0080e7          	jalr	720(ra) # 2d8 <procs>
  exit(1);
  10:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 174:	180080e7          	jalr	384(ra) # 2f0 <open>
  if(fd < 0)
 ...
 184:	188080e7          	jalr	392(ra) # 308 <fstat>
 188:	892a                	mv	s2,a0
  close(fd);
 18a:	8526                	mv	a0,s1
