...
00000000000001ec <main>:
{
 ...
 22a:	35a080e7          	jalr	858(ra) # 580 <open>
 22e:	84aa                	mv	s1,a0
...
stat(const char *n, struct stat *st)
{
 ...
 404:	180080e7          	jalr	384(ra) # 580 <open>
  if(fd < 0)
 ...
 414:	188080e7          	jalr	392(ra) # 598 <fstat>
 418:	892a                	mv	s2,a0
  close(fd);
 41a:	8526                	mv	a0,s1
...
malloc(uint nbytes)
{
 ...
 a3a:	b92080e7          	jalr	-1134(ra) # 5c8 <sbrk>
  if(p == (char*)-1)
