...
forktest(void)
{
  ...
  3e:	41e50513          	add	a0,a0,1054 # 458 <uptime+0xc>
  ...
  68:	40450513          	add	a0,a0,1028 # 468 <uptime+0x1c>
  ...
  b8:	40450513          	add	a0,a0,1028 # 4b8 <uptime+0x6c>
  ...
  d4:	3b850513          	add	a0,a0,952 # 488 <uptime+0x3c>
  ...
  ee:	3b650513          	add	a0,a0,950 # 4a0 <uptime+0x54>
...
stat(const char *n, struct stat *st)
{
 ...
 278:	180080e7          	jalr	384(ra) # 3f4 <open>
  if(fd < 0)
 ...
 288:	188080e7          	jalr	392(ra) # 40c <fstat>
 28c:	892a                	mv	s2,a0
  close(fd);
 28e:	8526                	mv	a0,s1
