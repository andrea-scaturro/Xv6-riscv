...
cat(int fd)
{
  ...
  44:	88058593          	add	a1,a1,-1920 # 8c0 <malloc+0xee>
  48:	4509                	li	a0,2
  4a:	00000097          	auipc	ra,0x0
  4e:	6a2080e7          	jalr	1698(ra) # 6ec <fprintf>
      exit(1);
  52:	4505                	li	a0,1
  ...
  72:	86a58593          	add	a1,a1,-1942 # 8d8 <malloc+0x106>
  76:	4509                	li	a0,2
  78:	00000097          	auipc	ra,0x0
  7c:	674080e7          	jalr	1652(ra) # 6ec <fprintf>
    exit(1);
  80:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  bc:	33a080e7          	jalr	826(ra) # 3f2 <open>
  c0:	84aa                	mv	s1,a0
 ...
 104:	7f058593          	add	a1,a1,2032 # 8f0 <malloc+0x11e>
 108:	4509                	li	a0,2
 10a:	00000097          	auipc	ra,0x0
 10e:	5e2080e7          	jalr	1506(ra) # 6ec <fprintf>
      exit(1);
 112:	4505                	li	a0,1
...
stat(const char *n, struct stat *st)
{
 ...
 276:	180080e7          	jalr	384(ra) # 3f2 <open>
  if(fd < 0)
 ...
 286:	188080e7          	jalr	392(ra) # 40a <fstat>
 28a:	892a                	mv	s2,a0
  close(fd);
 28c:	8526                	mv	a0,s1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	4d250513          	add	a0,a0,1234 # 968 <digits>
 49e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 59e:	37670713          	add	a4,a4,886 # 910 <malloc+0x13e>
 ...
 628:	344b8b93          	add	s7,s7,836 # 968 <digits>
 ...
 67c:	29090913          	add	s2,s2,656 # 908 <malloc+0x136>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 82e:	9e678793          	add	a5,a5,-1562 # 1210 <base>
