...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	e36080e7          	jalr	-458(ra) # ec6 <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	e04080e7          	jalr	-508(ra) # ea6 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	2a650513          	add	a0,a0,678 # 1350 <malloc+0xf2>
      b2:	00001097          	auipc	ra,0x1
      b6:	dfc080e7          	jalr	-516(ra) # eae <chdir>
  ...
  chdir("/");
      ...
      e2:	dd0080e7          	jalr	-560(ra) # eae <chdir>
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     116:	d6c080e7          	jalr	-660(ra) # e7e <open>
    ...
    if(what == 1){
     ...
     170:	d12080e7          	jalr	-750(ra) # e7e <open>
     ...
     18a:	d08080e7          	jalr	-760(ra) # e8e <unlink>
     ...
     19c:	d16080e7          	jalr	-746(ra) # eae <chdir>
     ...
     1ae:	ce4080e7          	jalr	-796(ra) # e8e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1c650513          	add	a0,a0,454 # 1378 <malloc+0x11a>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cf4080e7          	jalr	-780(ra) # eae <chdir>
     ...
     1f8:	c8a080e7          	jalr	-886(ra) # e7e <open>
     1fc:	8a2a                	mv	s4,a0
     ...
     21a:	c68080e7          	jalr	-920(ra) # e7e <open>
     21e:	8a2a                	mv	s4,a0
     ...
     28a:	c08080e7          	jalr	-1016(ra) # e8e <unlink>
     ...
     2c8:	bca080e7          	jalr	-1078(ra) # e8e <unlink>
     ...
     2da:	bb8080e7          	jalr	-1096(ra) # e8e <unlink>
      link("../grindir/./../a", "../b");
     ...
     2f2:	bb0080e7          	jalr	-1104(ra) # e9e <link>
     ...
     304:	b8e080e7          	jalr	-1138(ra) # e8e <unlink>
      link(".././b", "/grindir/../a");
     ...
     31c:	b86080e7          	jalr	-1146(ra) # e9e <link>
     ...
     3b6:	b14080e7          	jalr	-1260(ra) # ec6 <sbrk>
     3ba:	b3a5                	j	122 <go+0xaa>
    } else if(what == 16){
      if(sbrk(0) > break0)
     3bc:	4501                	li	a0,0
     3be:	00001097          	auipc	ra,0x1
     3c2:	b08080e7          	jalr	-1272(ra) # ec6 <sbrk>
     3c6:	d4aafee3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     3ca:	4501                	li	a0,0
     3cc:	00001097          	auipc	ra,0x1
     3d0:	afa080e7          	jalr	-1286(ra) # ec6 <sbrk>
     3d4:	40aa853b          	subw	a0,s5,a0
     3d8:	00001097          	auipc	ra,0x1
     3dc:	aee080e7          	jalr	-1298(ra) # ec6 <sbrk>
     ...
     3fe:	ab4080e7          	jalr	-1356(ra) # eae <chdir>
     ...
     42a:	a58080e7          	jalr	-1448(ra) # e7e <open>
     ...
     492:	a30080e7          	jalr	-1488(ra) # ebe <getpid>
     ...
     614:	86e080e7          	jalr	-1938(ra) # e7e <open>
        unlink("x");
     618:	00001517          	auipc	a0,0x1
     61c:	e9050513          	add	a0,a0,-368 # 14a8 <malloc+0x24a>
     620:	00001097          	auipc	ra,0x1
     624:	86e080e7          	jalr	-1938(ra) # e8e <unlink>
        exit(0);
     628:	4501                	li	a0,0
     ...
     658:	83a080e7          	jalr	-1990(ra) # e8e <unlink>
     ...
     66c:	816080e7          	jalr	-2026(ra) # e7e <open>
     670:	8b2a                	mv	s6,a0
      if(fd1 < 0){
     ...
     698:	802080e7          	jalr	-2046(ra) # e96 <fstat>
     ...
     6ca:	7c8080e7          	jalr	1992(ra) # e8e <unlink>
     ...
     8ce:	5ec080e7          	jalr	1516(ra) # eb6 <dup>
     8d2:	4785                	li	a5,1
     ...
     92c:	54e080e7          	jalr	1358(ra) # e76 <exec>
        fprintf(2, "grind: echo: not found\n");
     ...
     992:	528080e7          	jalr	1320(ra) # eb6 <dup>
     ...
     9d2:	4e8080e7          	jalr	1256(ra) # eb6 <dup>
     9d6:	4785                	li	a5,1
     ...
     a24:	456080e7          	jalr	1110(ra) # e76 <exec>
        fprintf(2, "grind: cat: not found\n");
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	41a080e7          	jalr	1050(ra) # e8e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	96450513          	add	a0,a0,-1692 # 13e0 <malloc+0x182>
     a84:	00000097          	auipc	ra,0x0
     a88:	40a080e7          	jalr	1034(ra) # e8e <unlink>
...
main()
{
    ...
    sleep(20);
     ...
     b84:	34e080e7          	jalr	846(ra) # ece <sleep>
    rand_next += 1;
     b88:	609c                	ld	a5,0(s1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d02:	180080e7          	jalr	384(ra) # e7e <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d12:	188080e7          	jalr	392(ra) # e96 <fstat>
     d16:	892a                	mv	s2,a0
  close(fd);
     d18:	8526                	mv	a0,s1
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1338:	b92080e7          	jalr	-1134(ra) # ec6 <sbrk>
  if(p == (char*)-1)
