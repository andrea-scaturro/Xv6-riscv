...
stat(const char *n, struct stat *st)
{
 ...
 42c:	180080e7          	jalr	384(ra) # 5a8 <open>
  if(fd < 0)
 ...
 43c:	188080e7          	jalr	392(ra) # 5c0 <fstat>
 440:	892a                	mv	s2,a0
  close(fd);
 442:	8526                	mv	a0,s1
...
malloc(uint nbytes)
{
 ...
 a62:	b92080e7          	jalr	-1134(ra) # 5f0 <sbrk>
  if(p == (char*)-1)
