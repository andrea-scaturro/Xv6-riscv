...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	2fe58593          	add	a1,a1,766 # 1310 <malloc+0xea>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2b858593          	add	a1,a1,696 # 1318 <malloc+0xf2>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	28650513          	add	a0,a0,646 # 1320 <malloc+0xfa>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	35a70713          	add	a4,a4,858 # 1420 <malloc+0x1fa>
    ...
    panic("runcmd");
      ...
      e4:	24850513          	add	a0,a0,584 # 1328 <malloc+0x102>
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fc:	d46080e7          	jalr	-698(ra) # e3e <exec>
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     100:	6490                	ld	a2,8(s1)
     102:	00001597          	auipc	a1,0x1
     106:	22e58593          	add	a1,a1,558 # 1330 <malloc+0x10a>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     13a:	d10080e7          	jalr	-752(ra) # e46 <open>
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1f258593          	add	a1,a1,498 # 1340 <malloc+0x11a>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1be:	cc4080e7          	jalr	-828(ra) # e7e <dup>
      close(p[0]);
     ...
     1e8:	16c50513          	add	a0,a0,364 # 1350 <malloc+0x12a>
    ...
    if(fork1() == 0){
     ...
     20e:	c74080e7          	jalr	-908(ra) # e7e <dup>
      close(p[0]);
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	dc2b8b93          	add	s7,s7,-574 # 1378 <malloc+0x152>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	d9050513          	add	a0,a0,-624 # 1358 <malloc+0x132>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cd060613          	add	a2,a2,-816 # 1380 <malloc+0x15a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	cc0b0b13          	add	s6,s6,-832 # 13a0 <malloc+0x17a>
  ...
  return ret;
     ...
     71e:	c6e50513          	add	a0,a0,-914 # 1388 <malloc+0x162>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c1450513          	add	a0,a0,-1004 # 1390 <malloc+0x16a>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	bf260613          	add	a2,a2,-1038 # 13a8 <malloc+0x182>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	b8aa0a13          	add	s4,s4,-1142 # 13b0 <malloc+0x18a>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b5c60613          	add	a2,a2,-1188 # 13b8 <malloc+0x192>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	abe60613          	add	a2,a2,-1346 # 1380 <malloc+0x15a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	ade60613          	add	a2,a2,-1314 # 13d0 <malloc+0x1aa>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ac870713          	add	a4,a4,-1336 # 1438 <malloc+0x212>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	9d460613          	add	a2,a2,-1580 # 13f0 <malloc+0x1ca>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a56:	9a658593          	add	a1,a1,-1626 # 13f8 <malloc+0x1d2>
     a5a:	4509                	li	a0,2
     a5c:	00000097          	auipc	ra,0x0
     a60:	6e4080e7          	jalr	1764(ra) # 1140 <fprintf>
    panic("syntax");
     a64:	00001517          	auipc	a0,0x1
     a68:	92450513          	add	a0,a0,-1756 # 1388 <malloc+0x162>
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a88:	98448493          	add	s1,s1,-1660 # 1408 <malloc+0x1e2>
     a8c:	4589                	li	a1,2
     a8e:	8526                	mv	a0,s1
     a90:	00000097          	auipc	ra,0x0
     a94:	3b6080e7          	jalr	950(ra) # e46 <open>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2a:	350080e7          	jalr	848(ra) # e76 <chdir>
     ...
     b3e:	8d658593          	add	a1,a1,-1834 # 1410 <malloc+0x1ea>
     b42:	4509                	li	a0,2
     b44:	00000097          	auipc	ra,0x0
     b48:	5fc080e7          	jalr	1532(ra) # 1140 <fprintf>
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cca:	180080e7          	jalr	384(ra) # e46 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cda:	188080e7          	jalr	392(ra) # e5e <fstat>
     cde:	892a                	mv	s2,a0
  close(fd);
     ce0:	8526                	mv	a0,s1
...
putc(int fd, char c)
{
     ea6:	1101                	add	sp,sp,-32
     ea8:	ec06                	sd	ra,24(sp)
     eaa:	e822                	sd	s0,16(sp)
     eac:	1000                	add	s0,sp,32
     eae:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     eb2:	4605                	li	a2,1
     eb4:	fef40593          	add	a1,s0,-17
     eb8:	00000097          	auipc	ra,0x0
     ebc:	f5e080e7          	jalr	-162(ra) # e16 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     eda:	0805c963          	bltz	a1,f6c <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eee:	5c650513          	add	a0,a0,1478 # 14b0 <digits>
     ef2:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     f2e:	02e05863          	blez	a4,f5e <printint+0x96>
     f32:	fc040793          	add	a5,s0,-64
    ...
    putc(fd, buf[i]);
     ...
     f54:	f56080e7          	jalr	-170(ra) # ea6 <putc>
  while(--i >= 0)
     f58:	197d                	add	s2,s2,-1
     f5a:	ff3918e3          	bne	s2,s3,f4a <printint+0x82>
}
     f5e:	70e2                	ld	ra,56(sp)
     f60:	7442                	ld	s0,48(sp)
     f62:	74a2                	ld	s1,40(sp)
     f64:	7902                	ld	s2,32(sp)
     f66:	69e2                	ld	s3,24(sp)
     f68:	6121                	add	sp,sp,64
     f6a:	8082                	ret
    x = -xx;
     f6c:	40b005bb          	negw	a1,a1
    neg = 1;
     f70:	4885                	li	a7,1
    x = -xx;
     f72:	bf85                	j	ee2 <printint+0x1a>

0000000000000f74 <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f90:	18090c63          	beqz	s2,1128 <vprintf+0x1b4>
     f94:	8aaa                	mv	s5,a0
     f96:	8bb2                	mv	s7,a2
     f98:	00158493          	add	s1,a1,1
  state = 0;
     f9c:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
     ...
     fa2:	4b55                	li	s6,21
     fa4:	a839                	j	fc2 <vprintf+0x4e>
        putc(fd, c);
     fa6:	85ca                	mv	a1,s2
     fa8:	8556                	mv	a0,s5
     faa:	00000097          	auipc	ra,0x0
     fae:	efc080e7          	jalr	-260(ra) # ea6 <putc>
     fb2:	a019                	j	fb8 <vprintf+0x44>
    } else if(state == '%'){
     fb4:	01498d63          	beq	s3,s4,fce <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
     fb8:	0485                	add	s1,s1,1
     fba:	fff4c903          	lbu	s2,-1(s1)
     fbe:	16090563          	beqz	s2,1128 <vprintf+0x1b4>
    if(state == 0){
     fc2:	fe0999e3          	bnez	s3,fb4 <vprintf+0x40>
      if(c == '%'){
     fc6:	ff4910e3          	bne	s2,s4,fa6 <vprintf+0x32>
        state = '%';
     fca:	89d2                	mv	s3,s4
     fcc:	b7f5                	j	fb8 <vprintf+0x44>
      if(c == 'd'){
     fce:	13490263          	beq	s2,s4,10f2 <vprintf+0x17e>
     fd2:	f9d9079b          	addw	a5,s2,-99
     fd6:	0ff7f793          	zext.b	a5,a5
     fda:	12fb6563          	bltu	s6,a5,1104 <vprintf+0x190>
     fde:	f9d9079b          	addw	a5,s2,-99
     fe2:	0ff7f713          	zext.b	a4,a5
     fe6:	10eb6f63          	bltu	s6,a4,1104 <vprintf+0x190>
     fea:	00271793          	sll	a5,a4,0x2
     fee:	00000717          	auipc	a4,0x0
     ff2:	46a70713          	add	a4,a4,1130 # 1458 <malloc+0x232>
    ...
    1010:	ebc080e7          	jalr	-324(ra) # ec8 <printint>
    1014:	8bca                	mv	s7,s2
      } else {
    ...
    102c:	ea0080e7          	jalr	-352(ra) # ec8 <printint>
    1030:	8bca                	mv	s7,s2
      state = 0;
    1032:	4981                	li	s3,0
    1034:	b751                	j	fb8 <vprintf+0x44>
    ...
    1048:	e84080e7          	jalr	-380(ra) # ec8 <printint>
    104c:	8bca                	mv	s7,s2
      state = 0;
    104e:	4981                	li	s3,0
    1050:	b7a5                	j	fb8 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    1052:	008b8c13          	add	s8,s7,8
    1056:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    105a:	03000593          	li	a1,48
    105e:	8556                	mv	a0,s5
    1060:	00000097          	auipc	ra,0x0
    1064:	e46080e7          	jalr	-442(ra) # ea6 <putc>
  putc(fd, 'x');
    1068:	07800593          	li	a1,120
    106c:	8556                	mv	a0,s5
    106e:	00000097          	auipc	ra,0x0
    1072:	e38080e7          	jalr	-456(ra) # ea6 <putc>
    1076:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    1078:	00000b97          	auipc	s7,0x0
    107c:	438b8b93          	add	s7,s7,1080 # 14b0 <digits>
    1080:	03c9d793          	srl	a5,s3,0x3c
    1084:	97de                	add	a5,a5,s7
    1086:	0007c583          	lbu	a1,0(a5)
    108a:	8556                	mv	a0,s5
    108c:	00000097          	auipc	ra,0x0
    1090:	e1a080e7          	jalr	-486(ra) # ea6 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1094:	0992                	sll	s3,s3,0x4
    1096:	397d                	addw	s2,s2,-1
    1098:	fe0914e3          	bnez	s2,1080 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    109c:	8be2                	mv	s7,s8
      state = 0;
    109e:	4981                	li	s3,0
    10a0:	bf21                	j	fb8 <vprintf+0x44>
        s = va_arg(ap, char*);
    10a2:	008b8993          	add	s3,s7,8
    10a6:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    10aa:	02090163          	beqz	s2,10cc <vprintf+0x158>
        while(*s != 0){
    10ae:	00094583          	lbu	a1,0(s2)
    10b2:	c9a5                	beqz	a1,1122 <vprintf+0x1ae>
          putc(fd, *s);
    10b4:	8556                	mv	a0,s5
    10b6:	00000097          	auipc	ra,0x0
    10ba:	df0080e7          	jalr	-528(ra) # ea6 <putc>
          s++;
    10be:	0905                	add	s2,s2,1
        while(*s != 0){
    10c0:	00094583          	lbu	a1,0(s2)
    10c4:	f9e5                	bnez	a1,10b4 <vprintf+0x140>
        s = va_arg(ap, char*);
    10c6:	8bce                	mv	s7,s3
      state = 0;
    10c8:	4981                	li	s3,0
    10ca:	b5fd                	j	fb8 <vprintf+0x44>
          s = "(null)";
    10cc:	00000917          	auipc	s2,0x0
    10d0:	38490913          	add	s2,s2,900 # 1450 <malloc+0x22a>
        while(*s != 0){
    10d4:	02800593          	li	a1,40
    10d8:	bff1                	j	10b4 <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    10da:	008b8913          	add	s2,s7,8
    10de:	000bc583          	lbu	a1,0(s7)
    10e2:	8556                	mv	a0,s5
    10e4:	00000097          	auipc	ra,0x0
    10e8:	dc2080e7          	jalr	-574(ra) # ea6 <putc>
    10ec:	8bca                	mv	s7,s2
      state = 0;
    10ee:	4981                	li	s3,0
    10f0:	b5e1                	j	fb8 <vprintf+0x44>
        putc(fd, c);
    10f2:	02500593          	li	a1,37
    10f6:	8556                	mv	a0,s5
    10f8:	00000097          	auipc	ra,0x0
    10fc:	dae080e7          	jalr	-594(ra) # ea6 <putc>
      state = 0;
    1100:	4981                	li	s3,0
    1102:	bd5d                	j	fb8 <vprintf+0x44>
        putc(fd, '%');
    1104:	02500593          	li	a1,37
    1108:	8556                	mv	a0,s5
    110a:	00000097          	auipc	ra,0x0
    110e:	d9c080e7          	jalr	-612(ra) # ea6 <putc>
        putc(fd, c);
    1112:	85ca                	mv	a1,s2
    1114:	8556                	mv	a0,s5
    1116:	00000097          	auipc	ra,0x0
    111a:	d90080e7          	jalr	-624(ra) # ea6 <putc>
      state = 0;
    111e:	4981                	li	s3,0
    1120:	bd61                	j	fb8 <vprintf+0x44>
        s = va_arg(ap, char*);
    1122:	8bce                	mv	s7,s3
      state = 0;
    1124:	4981                	li	s3,0
    1126:	bd49                	j	fb8 <vprintf+0x44>
    }
  }
}
    ...
    113a:	6c02                	ld	s8,0(sp)
    113c:	6161                	add	sp,sp,80
    113e:	8082                	ret
...
{
    1140:	715d                	add	sp,sp,-80
    1142:	ec06                	sd	ra,24(sp)
    1144:	e822                	sd	s0,16(sp)
    1146:	1000                	add	s0,sp,32
  ...
  vprintf(fd, fmt, ap);
    ...
    1162:	e16080e7          	jalr	-490(ra) # f74 <vprintf>
}
    1166:	60e2                	ld	ra,24(sp)
    1168:	6442                	ld	s0,16(sp)
    116a:	6161                	add	sp,sp,80
    116c:	8082                	ret
...
{
    116e:	711d                	add	sp,sp,-96
    1170:	ec06                	sd	ra,24(sp)
    1172:	e822                	sd	s0,16(sp)
    1174:	1000                	add	s0,sp,32
...
free(void *ap)
{
    ...
    11a8:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11aa:	ff050693          	add	a3,a0,-16
    ...
    11da:	00e6ea63          	bltu	a3,a4,11ee <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11f4:	02059813          	sll	a6,a1,0x20
    11f8:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    1208:	02061593          	sll	a1,a2,0x20
    120c:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    ...
    1238:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    123a:	02051493          	sll	s1,a0,0x20
    123e:	9081                	srl	s1,s1,0x20
    1240:	04bd                	add	s1,s1,15
    1242:	8091                	srl	s1,s1,0x4
    1244:	0014899b          	addw	s3,s1,1
    1248:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1276:	d9e90913          	add	s2,s2,-610 # 2010 <freep>
  if(p == (char*)-1)
    127a:	5afd                	li	s5,-1
    127c:	a895                	j	12f0 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    127e:	00001797          	auipc	a5,0x1
    1282:	e0a78793          	add	a5,a5,-502 # 2088 <base>
    ...
    129e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12a0:	02071693          	sll	a3,a4,0x20
    12a4:	01c6d713          	srl	a4,a3,0x1c
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1300:	b92080e7          	jalr	-1134(ra) # e8e <sbrk>
  if(p == (char*)-1)
